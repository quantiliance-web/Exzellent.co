...
const SkillsLab = () => {
  ...
  return (
    <div className="pt-24 pb-20">
      {/* Hero */}
      <section className="py-16 px-6 bg-gradient-to-b from-secondary/10 to-transparent">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-xs text-text-secondary mb-8 uppercase tracking-widest font-bold">
            ...
            <span className="text-secondary">Skills Lab</span>
          </nav>
          
          <h1 className="text-5xl md:text-7xl font-black text-white mb-6">Skills Lab</h1>
          <p className="text-xl text-text-secondary max-w-2xl">
            Advanced skills for the future of work. Master the technologies and 
            mental models that are redefining industries.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input 
              ...
              className="w-full bg-surface border border-border rounded-2xl py-3 pl-12 pr-4 text-white focus:outline-none focus:border-secondary transition-colors"
            />
          </div>
        </div>
      </section>
